...
> [!WARNING]
>
> 取り消し線が引かれている翻訳は維持されていません。内容は古いため、参照することはお勧めできません。
...
| 日本語                    | [docs-ja](https://github.com/slidevjs/docs-ja) | [ja.sli.dev](https://ja.sli.dev) | [@toreis-up](https://github.com/toreis-up) [@IkumaTadokoro](https://github.com/IkumaTadokoro)|
...
または [Vite extension for VS Code](https://marketplace.visualstudio.com/items?itemName=antfu.vite) を使用して、サイドバイサイドで編集できます。

## 翻訳に貢献する

[Discord Server](https://chat.sli.dev) に参加して、メンテナーに連絡してください。
